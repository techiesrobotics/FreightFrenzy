...
class TechiesPipeline extends OpenCvPipeline {
    ...
    private volatile FreightLocation position = FreightLocation.NOTFOUND;
    ...
    public void setupCamera(HardwareMap hardwareMap) {
     ...
     */
    public FreightLocation getPosition() {
        return position;
    }
