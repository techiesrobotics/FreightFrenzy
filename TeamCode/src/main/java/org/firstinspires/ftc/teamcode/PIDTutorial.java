/**
 * in reality, for these ftc applications, the system tends to be too noisy and can cause
 * excessive volatility for a purely PID algorithm
...
public class PIDTutorial extends LinearOpMode {
    ...
    public static PIDCoefficients pidCoeffs = new PIDCoefficients(0.2, 0, 0); //PID coefficients that need to be tuned probably through FTC dashboard
    public PIDCoefficients pidGains = new PIDCoefficients(0.2, 0, 0); //PID gains which we will define later in the process
